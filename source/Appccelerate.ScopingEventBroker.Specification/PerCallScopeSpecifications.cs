...
namespace Appccelerate.ScopingEventBroker.Specification
{
    ...
    public class when_no_scope_acquired : PerCallScopeSpecification
    {
        ...
        It should_invoke_asynchronous_subscriber = () => subscriber.OnBackgroundWasCalled.Should().BeTrue();

        It should_invoke_synchronous_subscriber = () => subscriber.OnPublisherWasCalled.Should().BeTrue();
    }
    ...
    public class when_scope_cancelled : PerCallScopeSpecification
    {
        ...
        It should_not_invoke_asynchronous_subscriber = () => subscriber.OnBackgroundWasCalled.Should().BeFalse();
